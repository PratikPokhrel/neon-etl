...
This folder defines all source code for the 'neon-pipeline' pipeline:
...
* Take a look at the sample under "sample_users_neon_pipeline.py" to get familiar with the syntax.
